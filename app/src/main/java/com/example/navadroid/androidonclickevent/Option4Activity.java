...
public class Option4Activity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        findViewById(R.id.act0N).setOnClickListener(onClickListener);
        findViewById(R.id.act0B).setOnClickListener(onClickListener);
    }
    ...
    private void nextPage(){
        Intent next = new Intent(this,Option5Activity.class);
        startActivity(next);
    }

    private void backPage(){
        Intent back = new Intent(this,Option3Activity.class);
        startActivity(back);
    }
