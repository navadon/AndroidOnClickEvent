...
//    private Button btnProcess;
    ...
    private void initView(){
        ...
        findViewById(R.id.act0N).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                nextPage();
                hideKeyboardInput(v);
        ...
        findViewById(R.id.act0B).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                backPage();
                hideKeyboardInput(v);
    ...
    private void nextPage(){
        Intent next = new Intent(this,Option3Activity.class);
        startActivity(next);
    }

    private void backPage(){
        Intent back = new Intent(this,Option1Activity.class);
        startActivity(back);
    }
