...
public class Option4Activity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        findViewById(R.id.btn_prev_04).setOnClickListener(onClickListener);
        findViewById(R.id.btn_next_04).setOnClickListener(onClickListener);
    }
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btn_process_4:
                        greet();
                        break;
                    case R.id.btn_prev_04:
                        prev();
                        break;
                    case R.id.btn_next_04:
                        next();
                        break;
                }
                hideKeyboardInput(v);
    ...
    public void prev() {
        Intent myIntent = new Intent(Option4Activity.this, Option3Activity.class);
        Option4Activity.this.startActivity(myIntent);
    }

    public void next() {
        Intent myIntent = new Intent(Option4Activity.this, Option5Activity.class);
        Option4Activity.this.startActivity(myIntent);
    }
