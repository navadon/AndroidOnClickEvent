...
public class Option2Activity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        findViewById(R.id.btn_next0).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
        ...
        findViewById(R.id.btn_back0).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent2 = new Intent(Option2Activity.this, Option1Activity.class);
